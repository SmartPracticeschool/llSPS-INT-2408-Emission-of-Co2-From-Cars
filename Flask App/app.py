...
import pickle
app = Flask(__name__)
model = pickle.load(open('carco2.pkl','rb'))
...
def login():
    ...
    if(p>256.2286785379569):
        return render_template('index.html',label1 = "CO2 EMISSION OF THE VEHICLE = "+str(p), label2 ="THRESHOLD VALUE : 256.2286785379569", label3 ="Car Company : "+str(BRAND), label4 ="Car Model : "+str(CM), label5 ="Model Year : "+str(MY), label6 ="Vechile Class Type : "+str(VC), label7 =" Your Vehicle is Siezed Because CO2 Emission From Your Vehicle is Greater Than the THRESHOLD VALUE")
    else:
        return render_template('index.html',label1 = "CO2 EMISSION OF THE VEHICLE = "+str(p), label2 ="THRESHOLD VALUE : 256.2286785379569", label3 ="You Are Safe!!! ")
